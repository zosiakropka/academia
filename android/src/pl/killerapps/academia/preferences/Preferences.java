...
public class Preferences {
	...
	public static Setter set() throws UninitializedException {
		return new Setter(getOrExcept());
	}
	public static Cleaner clear() throws UninitializedException {
		return new Cleaner(getOrExcept());
	}
	
	private static SharedPreferences getOrExcept() throws UninitializedException {
		if (preferences == null) {
