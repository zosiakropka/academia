...
def jsonize(queryset, *args, **kwargs):
    return serializers.serialize("json", queryset, *args, **kwargs)
...
#                 continue
# 
#             if field.__class__.__name__ == "User":
#                 tree[field_name] = getattr(obj, field_name).username
# 
...
# 
# 
# def query_to_list(query, **kwargs):
# 
#     tree = []
#     for entity in query:
#         tree.append(model_to_dict(entity, **kwargs))
#     return tree
# 
# 
